  ...
  const results = [
    {
      ...
      content: {
        situation:
          "Маркетолог крупного бренда спортивной одежды должен был доказать, что логотип бренда был виден во время трансляции матча, несмотря на то, что он был размещён на LED-панелях за воротами — в менее заметной зоне.",
        problem:
          "После трансляции партнёр усомнился в эффективности размещения, утверждая, что логотип был едва виден, и запросил пересчёт стоимости.",
        help: [
    ...
    },
    {
      ...
      content: {
        situation:
          "Совет директоров запросил отчёт, показывающий, какой бренд (клиент или ключевой конкурент) достиг большей визуальной видимости в дерби, разбивку по плейсментам и игровым моментам.",
        problem:
          "Публичные обзоры обычно считали упоминания и общие минуты без нормализации по качеству кадра.",
        help: [
    ...
    },
    {
      ...
      content: {
        situation:
          "Бренд использовал несколько медиаканалов (форма, зона тренеров, LED, графика студии) и хотел консолидировать все данные в единый отчёт.",
        problem:
          "Разрозненные отчёты от разных подрядчиков не позволяли увидеть общий вклад и пересечения в точках контакта.",
        help: [
    ...
    },
    {
      ...
      content: {
        situation:
          "PR-команде требовалось представить первичные цифры видимости в течение 30 минут после финального свистка для брифинга.",
        problem:
          "Ручная подготовка отчёта занимала часы, и данные часто устаревали к моменту встречи.",
        help: [
    ...
    },
    {
      ...
      content: {
        situation:
          "Активность шла одновременно на стадионе, в стриминге и в соцмедиа, требовался консолидированный отчёт для совета директоров.",
        problem:
          "Метрики разных каналов несопоставимы, AVE переоценивал часть показателей и не учитывал качество.",
        help: [
    ...
    },
    {
      ...
      content: {
        situation:
          "Маркетинг искал, где сократить расходы без потери доли голоса в следующем квартале.",
        problem:
          "Не было понимания, какие плейсменты дают наихудшую цену за 1 минуту качественной видимости.",
        help: [
    ...
    },
    {
      ...
      content: {
        situation:
          "Срок соглашения заканчивался, и правообладатель запросил рост бюджета на следующий сезон.",
        problem:
          "У закупщиков сомнения — «не завышена ли сумма» и «какая реальная отдача».",
        help: [
    ...
    <section id="analyses" className="business-results">
      ...
      <div className="business-results-container">
        ...
        <div className="business-results-cta">
          <button
            type="button"
            className="business-results-button"
            onClick={onOpenDemo}
          >
